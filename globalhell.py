...
################################################
# Author               : Global Hell Xploit                                                            #
# Nama Script     : Global Hell Xploit                                                       #
# Github               : https://github.com/GlobalHellXploit                          #
# Facebook          : https://www.facebook.com/ghx.xyz      #
# Instagram         : https://instagram.com/globalhell_?utm_medium=copy_link           #
# WhatsApp         : 083801821854                                                   #
# Python version : 2.7                                                                        #
#                                                                                                           #
#                THANKS TO HACKER PATAH HATI - PHANTOMSEC1337 - ITAMI TEAM                     #
################################################
...
def menu():
    ...
    logo()
    print(" "+p+"[¤] Author     : Global Hell Xploit") 
    print(" [¤] Github     : https://github.com/GlobalHellXploit")
    print(" [¤] ---------------------------------------------")
    print(" [¤] Nama       : "+nama)
    print(" [¤] ID         : "+id)
    print(" [¤] IP         : "+ip)
